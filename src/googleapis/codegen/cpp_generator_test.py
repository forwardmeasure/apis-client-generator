...
class CppApiTest(absltest.TestCase):
...
class CppGeneratorTest(absltest.TestCase):
...
#    self.assertTrue(found_date_time)
    ...
    def testDefaultPath(self):
        ...
        self.assertEquals('company/My/CustomPath/fake_api',
                          gen.api.module.path)
...
class CppLanguageModelDataValueTest(absltest.TestCase):
    ...
    def testRenderInteger(self):
        ...
        dv.SetTemplateValue('codeType', 'int16')
        # 2^16 doesnt fit in an int16
        self.assertEqual('65536', render_method(dv))


class CppLanguageModelTest(absltest.TestCase):
