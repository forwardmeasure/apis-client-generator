...
class FeaturesLoadingTest(BaseTargetsTest):
    ...
    def testGetFeatures(self):
        ...
        self.assertEquals('base-client-library',
                          features.get('baseClientLibrary'))
    ...
    def testGetFeaturesWithoutOverride(self):
        ...
        self.assertEquals('this-is-from-top-level',
                          features.get('releaseVersion'))
...
class FeaturesTest(BaseTargetsTest):
    ...
    def testExtractPathsFromDependencies(self):
        ...
        def CheckResults(environment, expected_req, expected_opt, expected_exclude):
            ...
            self.assertEquals(8, len(req_paths) +
                              len(opt_paths) + len(exclude_paths))
        ...
        bin_files = features.ExtractPathsFromDependencies(
            req, file_type='binary')
