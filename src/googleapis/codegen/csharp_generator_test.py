...
class NestedClassNameTest(absltest.TestCase):
    ...
    def testNestedClassName(self):
        ...
        self.assertEquals(
            'System.Collections.Generic.IList<A>', c_schema.code_type)
    ...
    def testNestedArray(self):
        ...
        self.assertEquals('EphemeralDisksData',
                          ephemeral_disk_schema.safeClassName)


class PackagePathTest(absltest.TestCase):
    ...
    def testPackagePath(self):
        ...
        self.assertEquals('Google.Apis.Nougat.Foo.v1.Data',
                          api.model_module.name)


class VersionWithDashTest(absltest.TestCase):
...
class MemberNameTest(absltest.TestCase):
